  ...
  return (
    <div  className='project-container'>
        ...
        <div className="project-row" >
            <Project title={"Android"} image={"/ofyWellness.jpg"} language={"Java & XML"} year={"2024"} href="https://github.com/PrathameshBhagat/OFY-Wellness"/>
        ...
        <div className="project-row" >
            <Project title={"Docs"} image={"/documentation.png"} language={"JS & PHP"} year={"2022"} href="https://github.com/PrathameshBhagat/Documentation-Project"/>
